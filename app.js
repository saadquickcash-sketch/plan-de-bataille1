...
function startPlanningWizard(text){
  ...
  c.msgs.push({role:'assistant',content:'Parfait, Saad ! Réponds à ce petit questionnaire (clique tes réponses puis « Envoyer »), et je crée aussitôt l\'onglet de ton planning personnalisé dans « Créations ».'});
  c.t=Date.now(); save(); renderMsgs(); renderList();
